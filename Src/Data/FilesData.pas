...
type
  TItemList = ARRAY [0 .. 25998] OF TItemFromList;
...
type
  TQuestMiscArray = Array [0 .. 299] of TQuestMisc;
{$ENDREGION}
...
type
  Reinforce2_Area = (Reinforce2_Area_Blade = 0, Reinforce2_Area_Sword = 35,
    // era 35
...
const
  reinforce2sectionSize: WORD = 960; // 960 dividido por 4
{$ENDREGION}
{$REGION 'Reinforce3'}

type
  ArmorAttributeReinforce = packed record
    DamageReduction, HealthIncrementPoints: ARRAY [0 .. 15] OF DWORD;
  end;

type
  Reinforce3_Area_ = (Reinforce3_Area_Helmet = 0,
    Reinforce3_Area_Shield = Reinforce3_Area_Helmet, Reinforce3_Area_Armor = 30,
    // era 30
...
const
  reinforce3sectionSize: WORD = 150; // era 150 dividi por 4
...
type
  TMapLimit_Custom = packed record
    StartX: DWORD;
    StartY: DWORD;
    FinalX: DWORD;
    FinalY: DWORD;
...
type
  TFileMapsData = packed record
    Limits: ARRAY [0 .. 74] OF TMapLimit;
  end;
...
type
  TRecipeData = packed record
    ...
    Null3: WORD;  //taxa sucesso 2
    Null4: WORD;  // Chance de cuplicar
